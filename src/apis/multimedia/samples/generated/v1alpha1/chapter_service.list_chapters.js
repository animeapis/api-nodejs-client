...
function main(parent) {
  // [START multimedia_v1alpha1_generated_ChapterService_ListChapters_async]
  /**
  ...
  async function callListChapters() {
    ...
    // Run request
    const iterable = await multimediaClient.listChaptersAsync(request);
  ...
  callListChapters();
  // [END multimedia_v1alpha1_generated_ChapterService_ListChapters_async]
}
