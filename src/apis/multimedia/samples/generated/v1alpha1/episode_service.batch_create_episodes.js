...
function main(requests, parent) {
  // [START multimedia_v1alpha1_generated_EpisodeService_BatchCreateEpisodes_async]
  /**
  ...
  async function callBatchCreateEpisodes() {
    // Construct request
    const request = {
      requests,
      parent,
  ...
  callBatchCreateEpisodes();
  // [END multimedia_v1alpha1_generated_EpisodeService_BatchCreateEpisodes_async]
}
