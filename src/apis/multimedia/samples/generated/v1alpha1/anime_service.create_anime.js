...
function main(anime) {
  // [START multimedia_v1alpha1_generated_AnimeService_CreateAnime_async]
  /**
  ...
  async function callCreateAnime() {
    // Construct request
    const request = {
      anime,
    };
    ...
    // Run request
    const response = await multimediaClient.createAnime(request);
    console.log(response);
  }

  callCreateAnime();
  // [END multimedia_v1alpha1_generated_AnimeService_CreateAnime_async]
}
