...
export class ChapterServiceClient {
  ...
  initialize() {
    ...
    // animeshon.multimedia.v1alpha1.ChapterService.
    ...
    const chapterServiceStubMethods =
        ['getChapter', 'listChapters', 'createChapter', 'batchCreateChapters', 'updateChapter', 'deleteChapter', 'reconcileChapters'];
 ...
 */
  getChapter(
      ...
      Promise<[
        ...
        protos.animeshon.multimedia.v1alpha1.IGetChapterRequest|undefined, {}|undefined
      ]>;
  getChapter(
      request: protos.animeshon.multimedia.v1alpha1.IGetChapterRequest,
      options: CallOptions,
 ...
 */
  createChapter(
      ...
      Promise<[
        protos.animeshon.multimedia.v1alpha1.IChapter,
        protos.animeshon.multimedia.v1alpha1.ICreateChapterRequest|undefined, {}|undefined
      ]>;
  createChapter(
      request: protos.animeshon.multimedia.v1alpha1.ICreateChapterRequest,
      options: CallOptions,
 ...
 */
  updateChapter(
      ...
      Promise<[
        protos.animeshon.multimedia.v1alpha1.IChapter,
        protos.animeshon.multimedia.v1alpha1.IUpdateChapterRequest|undefined, {}|undefined
      ]>;
  updateChapter(
      request: protos.animeshon.multimedia.v1alpha1.IUpdateChapterRequest,
      options: CallOptions,
 ...
 */
  deleteChapter(
      ...
      Promise<[
        ...
        protos.animeshon.multimedia.v1alpha1.IDeleteChapterRequest|undefined, {}|undefined
      ]>;
  deleteChapter(
      request: protos.animeshon.multimedia.v1alpha1.IDeleteChapterRequest,
      options: CallOptions,
 ...
 */
  async checkBatchCreateChaptersProgress(name: string): Promise<LROperation<protos.animeshon.multimedia.v1alpha1.BatchCreateChaptersResponse, protos.animeshon.multimedia.v1alpha1.OperationMetadata>>{
    ...
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.batchCreateChapters, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkReconcileChaptersProgress(name: string): Promise<LROperation<protos.animeshon.multimedia.v1alpha1.ReconcileChaptersResponse, protos.animeshon.multimedia.v1alpha1.OperationMetadata>>{
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.reconcileChapters, this._gaxModule.createDefaultBackoffSettings());
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Chapter]{@link animeshon.multimedia.v1alpha1.Chapter}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Chapter]{@link animeshon.multimedia.v1alpha1.Chapter} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [Chapter]{@link animeshon.multimedia.v1alpha1.Chapter}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listChaptersAsync(
    ...
    return this.descriptors.page.listChapters.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.animeshon.multimedia.v1alpha1.IChapter>;
  }
