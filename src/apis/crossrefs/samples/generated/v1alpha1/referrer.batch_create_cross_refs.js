...
function main(crossref) {
  ...
  async function callBatchCreateCrossRefs() {
    ...
    // Run request
    const response = await crossrefsClient.batchCreateCrossRefs(request);
    console.log(response);
  }

  callBatchCreateCrossRefs();
  // [END crossrefs_v1alpha1_generated_Referrer_BatchCreateCrossRefs_async]
}
