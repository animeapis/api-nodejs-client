...
function main(name) {
  // [START resourcemanager_v1alpha1_generated_ResourceManager_GetOrganization_async]
  /**
  ...
  callGetOrganization();
  // [END resourcemanager_v1alpha1_generated_ResourceManager_GetOrganization_async]
}
