...
function main(name) {
  // [START resourcemanager_v1alpha1_generated_ResourceManager_DeleteTeam_async]
  /**
  ...
  async function callDeleteTeam() {
    ...
    // Run request
    const response = await resourcemanagerClient.deleteTeam(request);
    console.log(response);
  }

  callDeleteTeam();
  // [END resourcemanager_v1alpha1_generated_ResourceManager_DeleteTeam_async]
}
