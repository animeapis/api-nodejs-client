...
function main(parent, activity) {
  // [START tracker_v1alpha1_generated_TrackerService_CreateActivity_async]
  /**
  ...
  async function callCreateActivity() {
    ...
    // Run request
    const response = await trackerClient.createActivity(request);
    console.log(response);
  }

  callCreateActivity();
  // [END tracker_v1alpha1_generated_TrackerService_CreateActivity_async]
}
