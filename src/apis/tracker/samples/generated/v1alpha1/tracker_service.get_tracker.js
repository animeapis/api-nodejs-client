...
function main(name) {
  // [START tracker_v1alpha1_generated_TrackerService_GetTracker_async]
  /**
  ...
  async function callGetTracker() {
    ...
    // Run request
    const response = await trackerClient.getTracker(request);
    console.log(response);
  }

  callGetTracker();
  // [END tracker_v1alpha1_generated_TrackerService_GetTracker_async]
}
