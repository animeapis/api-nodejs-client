...
import {Callback, CallOptions, Descriptors, ClientOptions, GrpcClientOptions, LROperation, PaginationCallback, GaxCall, IamClient, IamProtos} from 'google-gax';
...
export class TrackerServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    if (opts.fallback === 'rest') {
      ...
      lroOptions.httpRules = [{selector: 'google.iam.v1.IAMPolicy.GetIamPolicy',get: '/v1/{resource=users/*/trackers/*}:getIamPolicy',additional_bindings: [{get: '/v1/{resource=audiences/*/trackers/*}:getIamPolicy',}],
      },{selector: 'google.iam.v1.IAMPolicy.SetIamPolicy',post: '/v1/{resource=users/*/trackers/*}:setIamPolicy',body: '*',additional_bindings: [{post: '/v1/{resource=audiences/*/trackers/*}:setIamPolicy',body: '*',}],
      },{selector: 'google.iam.v1.IAMPolicy.TestIamPermissions',post: '/v1/{resource=users/*/trackers/*}:testIamPermissions',body: '*',additional_bindings: [{post: '/v1/{resource=audiences/*/trackers/*}:testIamPermissions',body: '*',}],
      }];
    }
 ...
 */
   ...
   */
  close(): Promise<void> {
    if (this.trackerServiceStub && !this._terminated) {
