...
function main(name) {
  // [START webpage_v1alpha1_generated_Archive_GetPage_async]
  /**
  ...
  async function callGetPage() {
    ...
    // Run request
    const response = await webpageClient.getPage(request);
    console.log(response);
  }

  callGetPage();
  // [END webpage_v1alpha1_generated_Archive_GetPage_async]
}
