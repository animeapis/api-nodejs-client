...
function main(name) {
  // [START webpage_v1alpha1_generated_Archive_DeletePage_async]
  /**
  ...
  async function callDeletePage() {
    ...
    // Run request
    const response = await webpageClient.deletePage(request);
    console.log(response);
  }

  callDeletePage();
  // [END webpage_v1alpha1_generated_Archive_DeletePage_async]
}
