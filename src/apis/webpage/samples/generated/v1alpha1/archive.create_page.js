...
function main(parent, page) {
  // [START webpage_v1alpha1_generated_Archive_CreatePage_async]
  /**
  ...
  async function callCreatePage() {
    ...
    // Run request
    const response = await webpageClient.createPage(request);
    console.log(response);
  }

  callCreatePage();
  // [END webpage_v1alpha1_generated_Archive_CreatePage_async]
}
