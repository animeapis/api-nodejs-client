...
function main(parent, uri) {
  // [START image_v1alpha1_generated_Image_ImportImage_async]
  /**
  ...
  async function callImportImage() {
    // Construct request
    const request = {
      parent,
      uri,
    ...
    // Run request
    const response = await imageClient.importImage(request);
    console.log(response);
  }

  callImportImage();
  // [END image_v1alpha1_generated_Image_ImportImage_async]
}
