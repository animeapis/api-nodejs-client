 ...
 * `src/v1alpha1/git_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './git_client_config.json';
...
export class GitClient {
  ...
  /**
   * Construct an instance of GitClient.
   *
   ...
   *     const client = new GitClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'animeshon.hub.v1alpha1.Git', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.gitStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
    ...
    const gitStubMethods =
        ['advertiseReferences', 'receivePack', 'uploadPack'];
    for (const methodName of gitStubMethods) {
      const callPromise = this.gitStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  advertiseReferences(
      ...
      Promise<[
        ...
        protos.animeshon.hub.v1alpha1.IAdvertiseReferencesRequest|undefined, {}|undefined
      ]>;
  advertiseReferences(
      request: protos.animeshon.hub.v1alpha1.IAdvertiseReferencesRequest,
      options: CallOptions,
 ...
 */
  receivePack(
      ...
      Promise<[
        protos.google.api.IHttpBody,
        protos.animeshon.hub.v1alpha1.IReceivePackRequest|undefined, {}|undefined
      ]>;
  receivePack(
      request: protos.animeshon.hub.v1alpha1.IReceivePackRequest,
      options: CallOptions,
 ...
 */
  uploadPack(
      ...
      Promise<[
        protos.google.api.IHttpBody,
        protos.animeshon.hub.v1alpha1.IUploadPackRequest|undefined, {}|undefined
      ]>;
  uploadPack(
      request: protos.animeshon.hub.v1alpha1.IUploadPackRequest,
      options: CallOptions,
  ...
  uploadPack(
    ...
    this.initialize();
    return this.innerApiCalls.uploadPack(request, options, callback);
  }
   ...
   */
  close(): Promise<void> {
    if (this.gitStub && !this._terminated) {
      return this.gitStub.then(stub => {
