...
function main(name) {
  // [START 127_v1alpha1_generated_AccessControl_GetResource_async]
  /**
  ...
  async function callGetResource() {
    ...
    // Run request
    const response = await grbacClient.getResource(request);
    console.log(response);
  }

  callGetResource();
  // [END 127_v1alpha1_generated_AccessControl_GetResource_async]
}
