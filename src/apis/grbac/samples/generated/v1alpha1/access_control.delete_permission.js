...
function main(name) {
  // [START 127_v1alpha1_generated_AccessControl_DeletePermission_async]
  /**
  ...
  async function callDeletePermission() {
    ...
    // Run request
    const response = await grbacClient.deletePermission(request);
    console.log(response);
  }

  callDeletePermission();
  // [END 127_v1alpha1_generated_AccessControl_DeletePermission_async]
}
