...
function main(name) {
  // [START 127_v1alpha1_generated_AccessControl_DeleteRole_async]
  /**
  ...
  async function callDeleteRole() {
    ...
    // Run request
    const response = await grbacClient.deleteRole(request);
    console.log(response);
  }

  callDeleteRole();
  // [END 127_v1alpha1_generated_AccessControl_DeleteRole_async]
}
