...
function main(permission) {
  // [START 127_v1alpha1_generated_AccessControl_CreatePermission_async]
  /**
  ...
  async function callCreatePermission() {
    ...
    // Run request
    const response = await grbacClient.createPermission(request);
    console.log(response);
  }

  callCreatePermission();
  // [END 127_v1alpha1_generated_AccessControl_CreatePermission_async]
}
