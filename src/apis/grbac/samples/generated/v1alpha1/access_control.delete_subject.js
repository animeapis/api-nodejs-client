...
function main(name) {
  // [START 127_v1alpha1_generated_AccessControl_DeleteSubject_async]
  /**
  ...
  async function callDeleteSubject() {
    ...
    // Run request
    const response = await grbacClient.deleteSubject(request);
    console.log(response);
  }

  callDeleteSubject();
  // [END 127_v1alpha1_generated_AccessControl_DeleteSubject_async]
}
