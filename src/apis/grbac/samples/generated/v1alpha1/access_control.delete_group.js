...
function main(name) {
  // [START 127_v1alpha1_generated_AccessControl_DeleteGroup_async]
  /**
  ...
  async function callDeleteGroup() {
    ...
    // Run request
    const response = await grbacClient.deleteGroup(request);
    console.log(response);
  }

  callDeleteGroup();
  // [END 127_v1alpha1_generated_AccessControl_DeleteGroup_async]
}
