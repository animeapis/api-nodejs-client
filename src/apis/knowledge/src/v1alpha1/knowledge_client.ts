 ...
 * `src/v1alpha1/knowledge_client_config.json`.
...
export class KnowledgeClient {
  ...
  /**
   * Construct an instance of KnowledgeClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.descriptors.page = {
      listContributions:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'contributions')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'animeshon.knowledge.v1alpha1.Knowledge', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.knowledgeStub) {
      return this.knowledgeStub;
    }

    // Put together the "service stub" for
    // animeshon.knowledge.v1alpha1.Knowledge.
    this.knowledgeStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
    ...
    const knowledgeStubMethods =
        ['getContribution', 'listContributions', 'createContribution', 'getContributionChanges', 'reviewContribution', 'approveContribution', 'rejectContribution', 'allocateResourceName'];
  ...
  static get servicePath() {
    return 'knowledge.animeapis.com';
  }
 ...
 */
  getContribution(
      ...
      Promise<[
        ...
        protos.animeshon.knowledge.v1alpha1.IGetContributionRequest|undefined, {}|undefined
      ]>;
  getContribution(
      request: protos.animeshon.knowledge.v1alpha1.IGetContributionRequest,
      options: CallOptions,
 ...
 */
  createContribution(
      ...
      Promise<[
        protos.animeshon.knowledge.v1alpha1.IContribution,
        protos.animeshon.knowledge.v1alpha1.ICreateContributionRequest|undefined, {}|undefined
      ]>;
  createContribution(
      request: protos.animeshon.knowledge.v1alpha1.ICreateContributionRequest,
      options: CallOptions,
 ...
 */
  approveContribution(
      ...
      Promise<[
        protos.animeshon.knowledge.v1alpha1.IContribution,
        protos.animeshon.knowledge.v1alpha1.IApproveContributionRequest|undefined, {}|undefined
      ]>;
  approveContribution(
      request: protos.animeshon.knowledge.v1alpha1.IApproveContributionRequest,
      options: CallOptions,
 ...
 */
  rejectContribution(
      ...
      Promise<[
        protos.animeshon.knowledge.v1alpha1.IContribution,
        protos.animeshon.knowledge.v1alpha1.IRejectContributionRequest|undefined, {}|undefined
      ]>;
  rejectContribution(
      request: protos.animeshon.knowledge.v1alpha1.IRejectContributionRequest,
      options: CallOptions,
 ...
 */
  allocateResourceName(
      ...
      Promise<[
        ...
        protos.animeshon.knowledge.v1alpha1.IAllocateResourceNameRequest|undefined, {}|undefined
      ]>;
  allocateResourceName(
      request: protos.animeshon.knowledge.v1alpha1.IAllocateResourceNameRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Contribution]{@link animeshon.knowledge.v1alpha1.Contribution}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listContributionsAsync()`
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Contribution]{@link animeshon.knowledge.v1alpha1.Contribution} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
...
/**
 * Equivalent to `listContributions`, but returns an iterable object.
 *
 ...
 *   [Contribution]{@link animeshon.knowledge.v1alpha1.Contribution}. The API will be called under the hood as needed, once per the page,
 ...
 */
   ...
   */
  close(): Promise<void> {
    if (this.knowledgeStub && !this._terminated) {
      return this.knowledgeStub.then(stub => {
