...
function main(parent) {
  // [START release_v1alpha1_generated_Publisher_ListReleases_async]
  /**
  ...
  async function callListReleases() {
    ...
    // Run request
    const iterable = await releaseClient.listReleasesAsync(request);
  ...
  callListReleases();
  // [END release_v1alpha1_generated_Publisher_ListReleases_async]
}
