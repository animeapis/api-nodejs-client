...
function main() {
  // [START release_v1alpha1_generated_Publisher_GetRelease_async]
  /**
  ...
  async function callGetRelease() {
    ...
    // Run request
    const response = await releaseClient.getRelease(request);
    console.log(response);
  }

  callGetRelease();
  // [END release_v1alpha1_generated_Publisher_GetRelease_async]
}
