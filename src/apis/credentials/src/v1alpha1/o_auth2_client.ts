 ...
 * `src/v1alpha1/o_auth2_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './o_auth2_client_config.json';
...
export class OAuth2Client {
  ...
  /**
   * Construct an instance of OAuth2Client.
   *
   ...
   *     const client = new OAuth2Client({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'animeshon.credentials.v1alpha1.OAuth2', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.oAuth2Stub) {
      return this.oAuth2Stub;
    }

    // Put together the "service stub" for
    // animeshon.credentials.v1alpha1.OAuth2.
    this.oAuth2Stub = this._gaxGrpc.createStub(
        this._opts.fallback ?
    ...
    const oAuth2StubMethods =
        ['signIn', 'exchange'];
    for (const methodName of oAuth2StubMethods) {
      const callPromise = this.oAuth2Stub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  signIn(
      ...
      Promise<[
        ...
        protos.animeshon.credentials.v1alpha1.ISignInRequest|undefined, {}|undefined
      ]>;
  signIn(
      request: protos.animeshon.credentials.v1alpha1.ISignInRequest,
      options: CallOptions,
 ...
 */
  exchange(
      ...
      Promise<[
        ...
        protos.animeshon.credentials.v1alpha1.IExchangeRequest|undefined, {}|undefined
      ]>;
  exchange(
      request: protos.animeshon.credentials.v1alpha1.IExchangeRequest,
      options: CallOptions,
  ...
  exchange(
    ...
    this.initialize();
    return this.innerApiCalls.exchange(request, options, callback);
  }
 ...
 */
   ...
   */
  close(): Promise<void> {
    if (this.oAuth2Stub && !this._terminated) {
      return this.oAuth2Stub.then(stub => {
