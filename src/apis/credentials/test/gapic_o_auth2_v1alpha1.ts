...
describe('v1alpha1.OAuth2Client', () => {
    ...
    describe('signIn', () => {
        it('invokes signIn without error', async () => {
            const client = new oauth2Module.v1alpha1.OAuth2Client({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
        ...
        it('invokes signIn without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.signIn(
                    request,
                    (err?: Error|null, result?: protos.animeshon.credentials.v1alpha1.ISignInResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('exchange', () => {
        it('invokes exchange without error', async () => {
            const client = new oauth2Module.v1alpha1.OAuth2Client({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
        ...
        it('invokes exchange without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exchange(
                    request,
                    (err?: Error|null, result?: protos.animeshon.credentials.v1alpha1.IExchangeResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
