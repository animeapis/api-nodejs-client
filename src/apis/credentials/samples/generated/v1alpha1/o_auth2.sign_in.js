...
function main(name) {
  // [START credentials_v1alpha1_generated_OAuth2_SignIn_async]
  /**
  ...
  async function callSignIn() {
    ...
    // Run request
    const response = await credentialsClient.signIn(request);
    console.log(response);
  }

  callSignIn();
  // [END credentials_v1alpha1_generated_OAuth2_SignIn_async]
}
