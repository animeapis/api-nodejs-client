...
function main(parent) {
  // [START credentials_v1alpha1_generated_Keeper_ListCredentials_async]
  /**
  ...
  async function callListCredentials() {
    ...
    // Run request
    const iterable = await credentialsClient.listCredentialsAsync(request);
  ...
  callListCredentials();
  // [END credentials_v1alpha1_generated_Keeper_ListCredentials_async]
}
