...
function main(credentials) {
  // [START credentials_v1alpha1_generated_Keeper_CreateCredentials_async]
  /**
  ...
  async function callCreateCredentials() {
    // Construct request
    const request = {
      credentials,
    };
    ...
    // Run request
    const response = await credentialsClient.createCredentials(request);
    console.log(response);
  }

  callCreateCredentials();
  // [END credentials_v1alpha1_generated_Keeper_CreateCredentials_async]
}
