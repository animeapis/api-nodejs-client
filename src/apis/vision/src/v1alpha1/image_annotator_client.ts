 ...
 * `src/v1alpha1/image_annotator_client_config.json`.
...
export class ImageAnnotatorClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'animeshon.vision.v1alpha1.ImageAnnotator', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // animeshon.vision.v1alpha1.ImageAnnotator.
 ...
 */
  analyzeImage(
      ...
      Promise<[
        ...
        protos.animeshon.vision.v1alpha1.IAnalyzeImageRequest|undefined, {}|undefined
      ]>;
  analyzeImage(
      request: protos.animeshon.vision.v1alpha1.IAnalyzeImageRequest,
      options: CallOptions,
 ...
 */
  getImageAnalysis(
      ...
      Promise<[
        ...
        protos.animeshon.vision.v1alpha1.IGetImageAnalysisRequest|undefined, {}|undefined
      ]>;
  getImageAnalysis(
      request: protos.animeshon.vision.v1alpha1.IGetImageAnalysisRequest,
      options: CallOptions,
 ...
 */
  deleteImageAnalysis(
      ...
      Promise<[
        ...
        protos.animeshon.vision.v1alpha1.IDeleteImageAnalysisRequest|undefined, {}|undefined
      ]>;
  deleteImageAnalysis(
      request: protos.animeshon.vision.v1alpha1.IDeleteImageAnalysisRequest,
      options: CallOptions,
 ...
 */
  createImageAnnotation(
      ...
      Promise<[
        ...
        protos.animeshon.vision.v1alpha1.ICreateImageAnnotationRequest|undefined, {}|undefined
      ]>;
  createImageAnnotation(
      request: protos.animeshon.vision.v1alpha1.ICreateImageAnnotationRequest,
      options: CallOptions,
 ...
 */
  updateImageAnnotation(
      ...
      Promise<[
        protos.animeshon.vision.v1alpha1.IImageAnnotation,
        protos.animeshon.vision.v1alpha1.IUpdateImageAnnotationRequest|undefined, {}|undefined
      ]>;
  updateImageAnnotation(
      request: protos.animeshon.vision.v1alpha1.IUpdateImageAnnotationRequest,
      options: CallOptions,
 ...
 */
  deleteImageAnnotation(
      ...
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.animeshon.vision.v1alpha1.IDeleteImageAnnotationRequest|undefined, {}|undefined
      ]>;
  deleteImageAnnotation(
      request: protos.animeshon.vision.v1alpha1.IDeleteImageAnnotationRequest,
      options: CallOptions,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [ImageAnalysis]{@link animeshon.vision.v1alpha1.ImageAnalysis}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listImageAnalysesAsync()`
 ...
 */
  ...
  listImageAnalyses(
    ...
    this.initialize();
    return this.innerApiCalls.listImageAnalyses(request, options, callback);
  }
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [ImageAnalysis]{@link animeshon.vision.v1alpha1.ImageAnalysis} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
...
/**
 * Equivalent to `listImageAnalyses`, but returns an iterable object.
 *
 ...
 *   [ImageAnalysis]{@link animeshon.vision.v1alpha1.ImageAnalysis}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listImageAnalysesAsync(
      request?: protos.animeshon.vision.v1alpha1.IListImageAnalysesRequest,
      options?: CallOptions):
    AsyncIterable<protos.animeshon.vision.v1alpha1.IImageAnalysis>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [ImageAnnotation]{@link animeshon.vision.v1alpha1.ImageAnnotation}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listImageAnnotationsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 */
  ...
  listImageAnnotations(
    ...
    this.initialize();
    return this.innerApiCalls.listImageAnnotations(request, options, callback);
  }
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [ImageAnnotation]{@link animeshon.vision.v1alpha1.ImageAnnotation} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listImageAnnotationsAsync()`
 *   method described below for async iteration which you can stop as needed.
...
/**
 * Equivalent to `listImageAnnotations`, but returns an iterable object.
 *
 * `for`-`await`-`of` syntax is used with the iterable to get response elements on-demand.
 * @param {Object} request
 *   The request object that will be sent.
 ...
 *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
 *   When you iterate the returned iterable, each element will be an object representing
 *   [ImageAnnotation]{@link animeshon.vision.v1alpha1.ImageAnnotation}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 ...
 */
  listImageAnnotationsAsync(
      request?: protos.animeshon.vision.v1alpha1.IListImageAnnotationsRequest,
      options?: CallOptions):
    AsyncIterable<protos.animeshon.vision.v1alpha1.IImageAnnotation>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
