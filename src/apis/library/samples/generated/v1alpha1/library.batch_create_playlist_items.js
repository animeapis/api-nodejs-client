...
function main(parent, item) {
  ...
  async function callBatchCreatePlaylistItems() {
    // Construct request
    const request = {
      parent,
      item,
    ...
    // Run request
    const response = await libraryClient.batchCreatePlaylistItems(request);
    console.log(response);
  }

  callBatchCreatePlaylistItems();
  // [END library_v1alpha1_generated_Library_BatchCreatePlaylistItems_async]
}
